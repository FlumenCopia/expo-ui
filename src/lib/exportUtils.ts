    ...
    const reportHTML = `
      ...
      <head>
        ...
        <style>
          ...
          .logo { width: 36px; height: 36px; background: #0F172A; border-radius: 8px; color: #FFFFFF; display: flex; align-items: center; justify-content: center; font-size: 20px; font-weight: 800; }
          .title { font-size: 18px; font-weight: 800; color: #0F172A; margin: 0; }
          .sub { font-size: 10px; color: #0F172A; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; margin-top: 2px; }
